...
public class AndroidPageObjectTest_Simple {
	...
	public void setUp() throws Exception {
	   ...
	   // System.out.println(classpathRoot);
	    ...
	    //PageFactory.initElements(new AppiumFieldDecorator(driver, 5, TimeUnit.SECONDS),	apiDemosPageObject);
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		PageFactory.initElements(new AppiumFieldDecorator(driver),	apiDemosPageObject);
	}
